...
; realX=3.1
	...
	ldc	3.1
	putstatic	sample2/realX F

; realY=realX

	getstatic	sample2/realX F
	putstatic	sample2/realY F

; realY=realY/5.6+realX*5.11

	getstatic	sample2/realY F
	ldc	5.6
	fdiv
	getstatic	sample2/realX F
	ldc	5.11
...
.limit stack 20
	ldc	20
putstatic sample2/z I
	W0012:
	iconst_0
getstatic sample2/z I
	if_icmpge	W0013
...
; j<=CALLfunct(100,200)
	...
	ldc	100
	ldc	200
invokestatic sample2/funct(II)I
	putstatic	sample2/j I
